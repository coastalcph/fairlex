...
import torchvision
from models.bert.bert import BertClassifier, LongformerClassifier, BertFeaturizer, LongformerFeaturizer
    ...
    if config.model in ('resnet50', 'resnet34', 'wideresnet50', 'densenet121'):
        if is_featurizer:
            ...
            model = initialize_torchvision_model(
                ...
                d_out=d_out,
                **config.model_kwargs)
    elif 'bert' in config.model or 'longformer' in config.model:
        if is_featurizer:
