...
#SBATCH -o logs/scotus_v04/scotus_issue_area_tfidf_interpreter_decision_direction.log
...
COMMAND="run_expt.py --dataset scotus --algorithm $ALGO $PARAM --root_dir data/linear_interpreter_datasets_decision_direction_seed_1/ \
