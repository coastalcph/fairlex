...
#SBATCH -o logs/scotus_v04/scotus_issue_area_tfidf_interpreter_respondent=person.log
...
COMMAND="run_expt.py --dataset scotus --algorithm $ALGO $PARAM --root_dir data/linear_interpreter_datasets_respondent=person_seed_1/ \
--log_dir logs_final_tfidf_interpreter/scotus/$ALGO/$ATTRIBUTE=person/seed_$RAND_NUM/ 
