...
#SBATCH -o logs/scotus_v04/scotus_issue_area_tfidf_interpreter_respondent.log
...
COMMAND="run_expt.py --dataset scotus --algorithm $ALGO --root_dir data/linear_interpreter_datasets_respondent_seed_1/ \
--log_dir logs_final_tfidf_interpreter/scotus/$ALGO/$ATTRIBUTE/seed_$RAND_NUM/ 
...
--model_path logs_final_tfidf_regressor/scotus/ERM/respondent/seed_1/
"
echo ''
echo $COMMAND
