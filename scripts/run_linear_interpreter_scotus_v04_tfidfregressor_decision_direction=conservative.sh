...
#SBATCH -o logs/scotus_v04/scotus_issue_area_tfidf_interpreter_decision_direction=conservative.log
...
COMMAND="run_expt.py --dataset scotus --algorithm $ALGO $PARAM --root_dir data/linear_interpreter_datasets_decision-direction=conservative_seed_1/ \
--log_dir logs_final_tfidf_interpreter/scotus/$ALGO/$ATTRIBUTE=conservative/seed_$RAND_NUM/ 
