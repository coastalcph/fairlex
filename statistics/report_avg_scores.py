...
GROUP_FIELDS = {'language': (0, 3), 'region': (1, 4), 'legal area': (0, 2)}
LOG_DIR = 'final_logs'
...
for group_field, (first_group, no_groups) in GROUP_FIELDS.items():
    ...
    for algorithm in ['ERM', 'IRM', 'groupDRO', 'REx']:
        scores = {'val': {'mF1': [], 'mF1[group]': [], 'mF1[worst]': [], 'GD': []},
                  'test': {'mF1': [], 'mF1[group]': [], 'mF1[worst]': [], 'GD': []}}
